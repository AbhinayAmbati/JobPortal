      ...
      <div className="bg-white p-8 rounded-xl shadow-lg w-96 border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-blue-600 text-white p-3 rounded-lg hover:bg-blue-700 disabled:bg-blue-300 font-semibold text-lg transition-colors duration-200 mt-4 transform hover:scale-[1.02]"
          >
            {isLoading ? (
